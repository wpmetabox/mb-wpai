...
<div class="repeater">
	...
	<div class="input" style="margin-bottom: 10px;">
		...
		<div class="input sub_input">
			<input type="hidden" name="<?= esc_attr( $field['_name'] ) ?>[is_ignore_empties]" value="0" />
		...
		<div class="switcher-target-is_variable_<?= esc_attr( $field_name ) ?>_<?= esc_attr( $field['id'] ) ?>_yes">
			<div class="input sub_input">
				<div class="input">
					<p>
		...
		<div class="switcher-target-is_variable_<?= esc_attr( $field_name ) ?>_<?= esc_attr( $field['id'] ) ?>_yes_csv">
			<div class="input sub_input">
				<div class="input">
					<p>
	...
	?>
	<div class="wpallimport-clear"></div>
	<div class="switcher-target-is_variable_<?= esc_attr( $field_name ) ?>_<?= esc_attr( $field['id'] ) ?>_no">
		<div class="input sub_input">
