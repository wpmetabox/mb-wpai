...
<div class="repeater">
	<div class="input" style="margin-bottom: 10px;">
		...
		<div class="input sub_input">
			...
			<input type="checkbox" value="1" id="is_ignore_empties<?= $field_name ?>_<?= $field['id'] ?>"
				name="<?= $field['_name'] ?>[is_ignore_empties]" <?php if ( ! empty( $current_field['is_ignore_empties'] ) )
					  echo 'checked="checked'; ?> />
			<label for="is_ignore_empties<?= $field_name ?>_<?= $field['id'] ?>">
		...
		<div class="switcher-target-is_variable_<?= $field_name ?>_<?= $field['id'] ?>_yes">
			<div class="input sub_input">
				<div class="input">
					<p>
		...
		<div class="switcher-target-is_variable_<?= $field_name ?>_<?= $field['id'] ?>_yes_csv">
			<div class="input sub_input">
				<div class="input">
					<p>
	...
	?>
	<div class="wpallimport-clear"></div>
	<div class="switcher-target-is_variable_<?= $field_name ?>_<?= $field['id'] ?>_no">
		<div class="input sub_input">
