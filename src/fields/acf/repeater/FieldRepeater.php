...
namespace wpai_meta_box_add_on\fields\acf\repeater;
...
/**
 * Class FieldRepeater
 * @package wpai_meta_box_add_on\fields\acf\repeater
 */
        ...
        if (!empty($values)){
            switch ($this->getMode()) {
                case 'xml':
                    ...
                    MetaboxService::update_post_meta($this, $this->getPostID(), $this->getFieldName(), $countRows);
                    break;
                case 'csv':
                    $countRows = 0;
