<div class="acf-flexible-content">
    ...
    <div class="add_layout">
        ...
        <div class="layout_buttons">
            <a href="javascript:void(0);" class="acf-button add_layout_button"><?php _e("Add Layout", 'mbai'); ?></a>
            <a href="javascript:void(0);" class="acf-button delete_layout_button"><?php _e("Delete Layout", 'mbai'); ?></a>
        </div>
    </div>
</div>