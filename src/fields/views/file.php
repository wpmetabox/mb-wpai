...
<div class="input">
    ...
    <a
        href="#help"
        class="wpallimport-help"
        title="<?php _e('If an attachment with the same file name is found in the Media Library then that file will be attached to this record instead of importing a new file. Disable this setting if your import has different files with the same file name.', 'mbai') ?>"
